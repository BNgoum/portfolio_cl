$( document ).ready(function() {
    $('.cl_projets--item').on('mouseover', function() {
        let src = $(this).children('.cl_projets--bg').attr('src');

        $('.cl_projets--full-bg').css('background-image', 'url(' + src + ')');

        $(this).children('.cl_projets--titre').addClass('cl_projet--titre-active');
        $(this).children('.cl_projets--sous-titre').addClass('cl_projet--sous-titre-active');
        
        $('.cl_projets--item').children('.cl_projets--bg').css('opacity', 0);
        $('.cl_projets--titre, .cl_projets--sous-titre').css('opacity', 0.5);
        $(this).children('.cl_projets--titre, .cl_projets--sous-titre').css('opacity', 1);
    })
    ...
    $('.cl_projets--item').on('mouseout', function() {
        ...
        $('.cl_projets--item').children().css('opacity', 1);
    })
